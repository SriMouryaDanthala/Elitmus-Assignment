...
BasicGame.Game.prototype = {
	...
	create: function () {
        ...
        this.row1box = this.add.sprite(this.world.centerX,this.world.height-20,'spriteset');
        this.row1box.frameName = 'outerbox.png';
        this.row1box.anchor.setTo(4.8,1);
        this.row1box.scale.setTo(0.122,0.5);

        this.row2box = this.add.sprite(this.world.centerX,this.world.height-20,'spriteset');
        this.row2box.frameName = 'outerbox.png';
        this.row2box.anchor.setTo(3.86,1);
        this.row2box.scale.setTo(0.122,0.5);

        this.row3box = this.add.sprite(this.world.centerX,this.world.height-20,'spriteset');
        this.row3box.frameName = 'outerbox.png';
        this.row3box.anchor.setTo(2.92,1);
        this.row3box.scale.setTo(0.122,0.5);

        this.row4box = this.add.sprite(this.world.centerX,this.world.height-20,'spriteset');
        this.row4box.frameName = 'outerbox.png';
        this.row4box.anchor.setTo(2,1);
        this.row4box.scale.setTo(0.122,0.5);
        ...
        this.boundingbox.scale.setTo(1.3,0.5);

        this.iconbox = this.add.sprite(this.world.centerX,this.world.height-20,'spriteset');
        this.iconbox.frameName = 'title.png';
        this.iconbox.anchor.setTo(0.1,1.05);
        this.iconbox.scale.setTo(1.2,1.3);
